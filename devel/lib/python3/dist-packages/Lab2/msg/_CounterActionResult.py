...
"""autogenerated by genpy from Lab2/CounterActionResult.msg. Do not edit."""
import codecs
import sys
...
class CounterActionResult(genpy.Message):
  ...
  _type = "Lab2/CounterActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','Lab2/CounterResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = Lab2.msg.CounterResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = Lab2.msg.CounterResult()
