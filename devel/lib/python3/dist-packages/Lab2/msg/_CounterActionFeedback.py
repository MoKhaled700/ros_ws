...
"""autogenerated by genpy from Lab2/CounterActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CounterActionFeedback(genpy.Message):
  ...
  _type = "Lab2/CounterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','Lab2/CounterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = Lab2.msg.CounterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = Lab2.msg.CounterFeedback()
