...
(cl:defmethod cl:initialize-instance :after ((m <CounterGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Lab2-msg:<CounterGoal> is deprecated: use Lab2-msg:CounterGoal instead.")))

(cl:ensure-generic-function 'Limit-val :lambda-list '(m))
(cl:defmethod Limit-val ((m <CounterGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Lab2-msg:Limit-val is deprecated.  Use Lab2-msg:Limit instead.")
  (Limit m))
