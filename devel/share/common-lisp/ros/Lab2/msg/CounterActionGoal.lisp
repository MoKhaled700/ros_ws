...
(cl:defclass <CounterActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type Lab2-msg:CounterGoal
    :initform (cl:make-instance 'Lab2-msg:CounterGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Lab2-msg:<CounterActionGoal> is deprecated: use Lab2-msg:CounterActionGoal instead.")))
