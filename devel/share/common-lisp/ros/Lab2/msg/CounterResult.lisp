...
(cl:defmethod cl:initialize-instance :after ((m <CounterResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Lab2-msg:<CounterResult> is deprecated: use Lab2-msg:CounterResult instead.")))

(cl:ensure-generic-function 'Limit_Reached-val :lambda-list '(m))
(cl:defmethod Limit_Reached-val ((m <CounterResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Lab2-msg:Limit_Reached-val is deprecated.  Use Lab2-msg:Limit_Reached instead.")
  (Limit_Reached m))
