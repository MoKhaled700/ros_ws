...
const double TICKS_PER_REVOLUTION = 40551; // For reference purposes.
const double WHEEL_RADIUS = 0.224/2; // Wheel radius in meters
const double WHEEL_BASE = 0.71; // Center of left tire to center of right tire
const double TICKS_PER_METER = 52869; // Original was ~
