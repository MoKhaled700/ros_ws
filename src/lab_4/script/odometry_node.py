...
class OdometryNode:
    ...
    def update_odom(self):
        ...
        if math.isnan(self.odomNew.pose.pose.position.x) or math.isnan(self.odomNew.pose.pose.position.y) or math.isnan(
            ...
            self.odomNew.pose.pose.position.x = odomOld.pose.pose.position.x
            self.odomNew.pose.pose.position.y = odomOld.pose.pose.position.y
            self.odomNew.pose.pose.orientation.z = odomOld.pose.pose.orientation.z
